#ifndef CSHIFT_LWF_CUSTOM_ALLOCATOR_H
#define CSHIFT_LWF_CUSTOM_ALLOCATOR_H
...
operator new (CShift::LWF::UInt32 size, Allocator &allocator) {
  return CShift::LWF::Custom::Allocator::Cast<Allocator>
      ::allocator(allocator).allocate(size);
}
template <typename Allocator>
inline CShift::LWF::Void *

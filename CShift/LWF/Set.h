#ifndef CSHIFT_LWF_SET_H
#define CSHIFT_LWF_SET_H
...
template <typename Type,
          typename Comparer  = LWF::Collection::Set::Comparer<Type>,
          typename Allocator = LWF::Collection::Set::Allocator<Type>,
          Bool     countable = False>
struct Set
  : LWF::Binary::Search::RB::Tree<
       Type, False, Type, Comparer, Allocator, countable>
{
  private: typedef
    LWF::Binary::Search::RB::Tree<
       Type, False, Type, Comparer, Allocator, countable> Base;
  public:

#ifndef CSHIFT_LWF_UNORDERED_SET_H
#define CSHIFT_LWF_UNORDERED_SET_H
...
}}} // namespace Collection::Unordered::Set

namespace Unordered {

template <typename Type,
          typename Hasher     = LWF::Collection::Unordered::Set::Hasher<Type>,
          typename Predicator = LWF::Collection::Unordered::Set::Predicator<Type>,
          typename Allocator  = LWF::Collection::Unordered::Set::Allocator<Type>,
          LWF::Collection::Hash::Chaining::Table::Kind
                   kind       = LWF::Collection::Hash::Chaining::Table::vector/*|deque*/>
struct Set
  : LWF::Hash::Chaining::Table<
      Type, False, Type, Hasher, Predicator,
      Allocator, kind>
{
  private: typedef
    LWF::Hash::Chaining::Table<
...
#endif // CSHIFT_LWF_UNORDERED_SET_H

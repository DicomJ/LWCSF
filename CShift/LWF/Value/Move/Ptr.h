#ifndef CSHIFT_LWF_VALUE_MOVE_PTR_H
#define CSHIFT_LWF_VALUE_MOVE_PTR_H
...
struct Value<Type>::Move::Ptr
    : LWF::Ptr< LWF::Traits::Value::Ptr<LWF::Move::Ptr<Type *>, Index> > {
  private: typedef LWF::Move::Ptr<Type *> Traits;
...
#endif // CSHIFT_LWF_VALUE_MOVE_PTR_H

#ifndef CSHIFT_TEXT_CHARACTER_CODE_CASE_TITLE_H
#define CSHIFT_TEXT_CHARACTER_CODE_CASE_TITLE_H
...
struct Title {
  Title(const Encoding &, const Position &/*begin*/, const Position &/*end*/) {}
...
#endif // CSHIFT_TEXT_CHARACTER_CODE_CASE_TITLE_H

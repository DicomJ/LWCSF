#ifndef CSHIFT_TEXT_CHARACTER_CODE_CASE_UPPER_H
#define CSHIFT_TEXT_CHARACTER_CODE_CASE_UPPER_H
...
struct Upper {
  Upper(const Encoding &, const Position &/*begin*/, const Position &/*end*/) {}
...
#endif // CSHIFT_TEXT_CHARACTER_CODE_CASE_UPPER_H
